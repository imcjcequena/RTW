...
module.exports = function(){
  ...
  function startCamera(success, error){
      ...
      window.navigator.mediaDevices.getUserMedia({
        ...
        video: {
          ...
          width: {ideal: Math.min(currentCamera.width, 720)},
          height: {ideal: Math.min(currentCamera.height, 720)}
        }
  ...
  function getCurrentImageData(videoElement){
    if (!tmpCanvas) tmpCanvas = getTempCanvasAndContext(videoElement);
    tmpCanvas.context.drawImage(videoElement, 0, 0, tmpCanvas.canvas.width, tmpCanvas.canvas.height);
    return tmpCanvas.context.getImageData(0, 0, tmpCanvas.canvas.width, tmpCanvas.canvas.height);
  }
  ...
  function scan(success, error) {
    ...
    show(function(ignore){
      ...
      thisScanCycle = function(){
        let imgdata = getCurrentImageData(video);
        //scanWorker.postMessage(imgdata);
        let code = null;
        try {
